...
let current_users: string[] = ["Naxisine", "John", "Meave", "Alexie", "Ellie"];
let new_users: string[] = ["Salman", "JoHn", "Ottis", "Harry", "ElLIe"];
//Creating a soft copy of arrays.
let current_upper: string[] = current_users.map(element => element.toUpperCase());
let new_uppers: string[] = new_users.map(element => element.toUpperCase());
